...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			var _this = this;
			_this.keyMap = config.keyMap ? config.keyMap : {areaCode:'areaCode', areaName:'areaName', childs:'childs'};
			_this.checkDataType();
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText){
			...
			//列
				...
				if(_this.jsonType){
					...
					//行
						tempHTML += '<li data-id="'+wheelsData[i].data[j][_this.keyMap.areaCode]+'">'+wheelsData[i].data[j][_this.keyMap.areaName]+'</li>';
					}
				}else{
					for(var j=0; j<wheelsData[i].data.length; j++){
					//行
		...
		generateArrData: function (targetArr) {
			var tempArr = [];
			var keyMap_id = this.keyMap.areaCode;
			var keyMap_areaName = this.keyMap.areaName;
			for(var i=0; i<targetArr.length; i++){
				var tempObj = {};
				tempObj[keyMap_id] = targetArr[i][this.keyMap.areaCode];
				tempObj[keyMap_areaName] = targetArr[i][this.keyMap.areaName];
			...
			//列
				(function (i) {
					...
					if(_this.wheel[i]){
						...
						//行
							tempHTML += '<li data-id="'+_this.displayJson[i][j][_this.keyMap.areaCode]+'">'+_this.displayJson[i][j][_this.keyMap.areaName]+'</li>';
						}
		...
		updateWheel: function(sliderIndex, data){
	    	...
	    	if(_this.cascade){
				...
				for(var j=0; j<data.length; j++){
					tempHTML += '<li data-id="'+data[j][_this.keyMap.areaCode]+'">'+data[j][_this.keyMap.areaName]+'</li>';
				}
